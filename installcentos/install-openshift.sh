...
export SCRIPT_REPO=${SCRIPT_REPO:="https://raw.githubusercontent.com/srvreeswijk/local_openshift/master"}
...
curl -o inventory.download $SCRIPT_REPO/installcentos/inventory.ini
